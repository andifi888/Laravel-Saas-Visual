            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <label class="flex items-center mt-2">
                        <input type="checkbox" name="is_active" value="1" {{ $product->is_active ? 'checked' : '' }} class="rounded border-gray-300 text-blue-600">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" id="description" rows="4" class="input-custom w-full">{{ old('description', $product->description) }}</textarea>
                </div>
            </div>
